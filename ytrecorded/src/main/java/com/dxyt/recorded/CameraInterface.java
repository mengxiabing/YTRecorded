...
import com.dxyt.recorded.util.AngleUtil;
import com.dxyt.recorded.util.CameraParamUtil;
import com.dxyt.recorded.util.CheckPermission;
import com.dxyt.recorded.util.DeviceUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    //视频质量
    private int mediaQuality = YTCameraView.MEDIA_QUALITY_MIDDLE;
